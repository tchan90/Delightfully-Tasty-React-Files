...
class CategoryBrowse extends Component {
	...
	componentDidMount() {
		...
		axios
			.get(
				`https://www.delightfullytastymelb.com/wp-json/wp/v2/posts?per_page=8&categories=${this.props.match.params.catId}`
			)
			.then((res) => {
				this.setState({
					posts: res.data,
	...
	nextPage = (pageNumber) => {
		...
		axios
			.get(
				`https://www.delightfullytastymelb.com/wp-json/wp/v2/posts/?per_page=8&categories=${this.props.match.params.catId}&page=${pageNumber}`
			)
			.then((res) => {
				this.setState({
					posts: res.data,
	...
	searchResults = (event) => {
		...
		axios
			.get(
				`https://www.delightfullytastymelb.com/wp-json/wp/v2/posts?per_page=8&categories=${this.props.match.params.catId}&search=${this.state.search}`
			)
			.then((res) => {
				if (!res.data.length) {
					this.setState({
	...
	searchNext = (pageNumber) => {
		...
		axios
			.get(
				`https://www.delightfullytastymelb.com/wp-json/wp/v2/posts/?per_page=8&categories=${this.props.match.params.catId}&search=${this.state.search}&page=${pageNumber}`
			)
			.then((res) => {
				this.setState({
					posts: res.data,
